...
# 한글 설정
matplotlib.rcParams['font.family'] = 'NanumGothicCoding' # 맑은 고딕으로 설정
...
# 파일 불러오기
pre_sale = pd.read_csv('전국 평균 분양가격(2019년 11월).csv', encoding='euc-kr')
...
print("# 연도와 월은 카테고리 형태의 데이터이기 때문에 스프링 형태로 변경")
...
pd.options.display.float_format = '{:,.0f}'.format # 천단위 구분 기호
...
# 전국 규모(면적)별 신규 민간 아파트 분양가격 46부터 시작
# 결측치 확인
